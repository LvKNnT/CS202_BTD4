...
MainMenuState::MainMenuState()
    ...
    std::shared_ptr<PanelElement> resumeButton = std::make_shared<Resume>(buttonTex, 30, buttonHeight, buttonWidth, Vector2{firstButtonPos.x, firstButtonPos.y + buttonHeight});
    std::shared_ptr<PanelElement> optionsButton = std::make_shared<Options>(buttonTex, 30, buttonHeight, buttonWidth, Vector2{firstButtonPos.x, firstButtonPos.y + 2 * buttonHeight});
    std::shared_ptr<PanelElement> exitButton = std::make_shared<Exit>(buttonTex, 30, buttonHeight, buttonWidth, Vector2{firstButtonPos.x, firstButtonPos.y + 3 * buttonHeight});
