...
class Moab : public Enemy {
public:
    Moab(Vector2 position = {0.0f, 0.0f});
    ~Moab() override;
    ...
    void setDebuff(const BloonDebuff& normalDebuff, const BloonDebuff& moabDebuff) override; // MOAB has its own debuff handling
