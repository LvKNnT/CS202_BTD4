#ifndef ELITE_DEFENDER_PASSIVE_SKILL_H
#define ELITE_DEFENDER_PASSIVE_SKILL_H

#include "../Skill.h"

class EliteDefenderPassiveSkill : public Skill {
private:
    float lastCooldownBuff;

public:
    EliteDefenderPassiveSkill();
    ~EliteDefenderPassiveSkill() override = default;
...
#endif // ELITE_DEFENDER_PASSIVE_SKILL_H