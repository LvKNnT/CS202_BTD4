#ifndef FIRST_STRIKE_CAPABILITY_SKILL_H
#define FIRST_STRIKE_CAPABILITY_SKILL_H

#include "../Skill.h"

class FirstStrikeCapabilitySkill : public Skill {
public:
    FirstStrikeCapabilitySkill();
    ~FirstStrikeCapabilitySkill() override = default;
...
#endif // FIRST_STRIKE_CAPABILITY_SKILL_H