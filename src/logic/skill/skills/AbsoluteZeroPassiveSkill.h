#ifndef ABSOLUTE_ZERO_PASSIVE_SKILL_H
#define ABSOLUTE_ZERO_PASSIVE_SKILL_H

#include "../Skill.h"

class AbsoluteZeroPassiveSkill : public Skill {
public:
    AbsoluteZeroPassiveSkill();
    ~AbsoluteZeroPassiveSkill() override = default;
...
#endif // ABSOLUTE_ZERO_PASSIVE_SKILL_H