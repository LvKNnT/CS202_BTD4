#ifndef SHRAPNEL_SHOT_BULLET_H
#define SHRAPNEL_SHOT_BULLET_H

#include "../Bullet.h"

class ShrapnelShotBullet : public Bullet {
public:
    ShrapnelShotBullet();
    std::unique_ptr<Bullet> clone() const override;
    ~ShrapnelShotBullet() override = default;
