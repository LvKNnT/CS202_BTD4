#ifndef FLASH_BOMB_EXPLOSION_BULLET_H
#define FLASH_BOMB_EXPLOSION_BULLET_H

#include "../Bullet.h"

class FlashBombExplosionBullet : public Bullet {
public:
    FlashBombExplosionBullet();
    std::unique_ptr<Bullet> clone() const override;
    ~FlashBombExplosionBullet() override = default;
...
#endif // FLASH_BOMB_EXPLOSION_BULLET_H