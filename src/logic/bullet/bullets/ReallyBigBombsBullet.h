#ifndef REALLY_BIG_BOMBS_BULLET_H
#define REALLY_BIG_BOMBS_BULLET_H

#include "../Bullet.h"

class ReallyBigBombsBullet : public Bullet {
public:
    ReallyBigBombsBullet();
    std::unique_ptr<Bullet> clone() const override;
    ~ReallyBigBombsBullet() override = default;
...
#endif // REALLY_BIG_BOMBS_BULLET_H