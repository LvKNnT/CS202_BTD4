#ifndef MOAB_ASSASSIN_BULLET_H
#define MOAB_ASSASSIN_BULLET_H

#include "../Bullet.h"

class MOABAssassinBullet : public Bullet {
public:
    MOABAssassinBullet();
    std::unique_ptr<Bullet> clone() const override;
    ~MOABAssassinBullet() override = default;
