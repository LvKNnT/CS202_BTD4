#ifndef RECURSIVE_CLUSTER_BULLET_H
#define RECURSIVE_CLUSTER_BULLET_H

#include "../Bullet.h"

class RecursiveClusterBullet : public Bullet {
public:
    RecursiveClusterBullet();
    std::unique_ptr<Bullet> clone() const override;
    ~RecursiveClusterBullet() override = default;
...
#endif // RECURSIVE_CLUSTER_BULLET_H