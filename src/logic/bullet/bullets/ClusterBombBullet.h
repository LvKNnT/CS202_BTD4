#ifndef CLUSTER_BOMB_BULLET_H
#define CLUSTER_BOMB_BULLET_H

#include "../Bullet.h"

class ClusterBombBullet : public Bullet {
public:
    ClusterBombBullet();
    std::unique_ptr<Bullet> clone() const override;
    ~ClusterBombBullet() override = default;
