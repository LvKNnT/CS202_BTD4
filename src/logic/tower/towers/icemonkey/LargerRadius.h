#ifndef LARGER_RADIUS_H
#define LARGER_RADIUS_H

#include "../../Upgrade.h"

class LargerRadius : public Upgrade {
public:
    LargerRadius();
    LargerRadius(const LargerRadius& other);
    std::unique_ptr<Upgrade> clone() const override;
    ~LargerRadius() override = default;
